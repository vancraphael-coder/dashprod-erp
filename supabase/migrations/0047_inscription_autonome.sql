...
--   - il faut être authentifié (Google) → identité réelle, pas d'anonyme
--   - il faut n'appartenir à aucune organisation → une seule par identité
--   - l'e-mail ne doit pas déjà être invité ailleurs
-- Un même compte ne peut donc pas créer de sociétés en série.
--
-- L'appelant devient administrateur de SA société, rattaché immédiatement :
-- pas d'invitation à réclamer, il vient de s'authentifier.
-- =============================================================================
...
-- ── Retrait de la création réservée à l'éditeur ────────────────────────────
-- Elle n'a pas sa place dans une application cliente.
