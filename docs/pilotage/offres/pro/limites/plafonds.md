...
| | |
|---|---|
| Prix de base | **720 € HTVA** par mois |
| Remise annuelle | 5 % |
| Membres | 30 compris, **aucun plafond** — le membre supplémentaire se facture 13 € |
| Centres logistiques | 1 compris, aucun plafond (+50 € par centre) |
| Secteur | Déménagement (échelle principale) |
